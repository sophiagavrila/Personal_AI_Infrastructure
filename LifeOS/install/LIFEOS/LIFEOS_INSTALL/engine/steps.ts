/**
 * LifeOS Installer v6.0 — Step Definitions
...
export const STEPS: StepDefinition[] = [
  {
    ...
    description: "Detect operating system, installed tools, and existing LifeOS installation",
    number: 1,
    required: true,
    dependsOn: [],
  },
  ...
  {
    id: "repository",
    name: "LifeOS Repository",
    description: "Clone or update the LifeOS repository into ~/.claude",
    number: 5,
    required: true,
    dependsOn: ["identity"],
  },

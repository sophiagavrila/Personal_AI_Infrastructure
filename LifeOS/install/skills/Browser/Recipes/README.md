...
| `tool` | Yes | Which tool executes: `agent-browser` or `ai-agent` |
...
| `ai-agent` | AI-driven via general-purpose agent — page-dependent decisions or structured validation |

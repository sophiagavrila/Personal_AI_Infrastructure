...
### 4. Verify AI-agent automation

```
Agent(subagent_type="general-purpose", prompt="Navigate to https://example.com. Take a snapshot. Report page title.")
```
...
# Agents: general-purpose (headless agent-browser)

...
2. **Version diff** — compare the installed plugin version (`.claude-plugin/plugin.json`) against the user's current install marker. If equal, report "already current" and exit.

...
**KEY TRIGGER: The word "custom" means truly unique agents - NOT static types — always use `general-purpose` with ComposeAgent prompts.**
...
**CRITICAL: Use `subagent_type: "general-purpose"` - NEVER use static built-in types for custom agents.**

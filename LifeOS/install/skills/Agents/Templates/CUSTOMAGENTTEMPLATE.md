...
> Canonical identity schema for all LifeOS agents — built-in and custom.
...
---
# === Identity ===
name: ""                    # Agent type name (e.g., "SecurityAnalyst", "DataScientist")
...
[Standard LifeOS output format with sections:
...
| `subagent_type` | Uses agent name (e.g., `Explore`, `Forge`) | Always `general-purpose` |
| Lifecycle | Permanent, ships with LifeOS | User-managed (create/delete) |

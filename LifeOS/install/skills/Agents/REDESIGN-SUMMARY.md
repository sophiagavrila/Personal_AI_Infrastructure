...
> **Retirement note (2026):** This is a historical record of the 2025-12-18 redesign. The `Architect`, `Engineer`, and `Designer` agent *types* have since been retired; their `*Context.md` reading-lists remain and are loaded onto a **`general-purpose`** agent. The examples below are preserved as-is for historical accuracy.
...
- ❌ Duplicated LifeOS content (stack preferences, coding standards)
...
- ✅ Supplements LifeOS without redundancy
...
- **LIFEOS/CONSTITUTION.md** - Foundational principles
- **LIFEOS/CoreStack.md** - Stack preferences
...
1. **No Duplication**: LifeOS already provides constitutional principles, stack preferences, etc.
...
4. **Supplements LifeOS**: Adds agent-specific context without replacing base knowledge

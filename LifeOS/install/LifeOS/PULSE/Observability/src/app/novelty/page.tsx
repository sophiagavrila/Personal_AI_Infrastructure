...
function ScoreBar({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="text-[13px] text-foreground/80 w-16 flex-shrink-0">
        {label}
      </span>
    ...
    <div className="glass-panel rounded-xl p-4">
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        {candidate.lineage.map((l) => (
          <span
            key={l}
            className="px-2 py-1 rounded text-[13px] bg-white/[0.05] text-foreground/80"
          >
            {l}
          </span>
        ))}
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="glass-panel rounded-2xl p-4">
        ...
        <p className="text-sm text-foreground/80">{run.problem}</p>
      ...
      <div className="glass-panel rounded-2xl p-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-[13px] font-semibold uppercase tracking-wider text-foreground/80">
            Phase Pipeline
          </span>
        </div>
      ...
      {run.fitnessTrajectory.length > 0 && (
        <div className="glass-panel rounded-2xl p-4">
          <span className="text-[13px] font-semibold uppercase tracking-wider text-foreground/80 mb-3 block">
            Fitness Trajectory
          </span>
          <div className="h-48">
      ...
      {run.candidates.length > 0 && (
        <div>
          <span className="text-[13px] font-semibold uppercase tracking-wider text-foreground/80 mb-3 block px-1">
            Top Candidates
          </span>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/[0.04]">
                <th className="px-4 py-2 text-left text-[13px] font-medium text-foreground/80">
                  Pairing
                </th>
                <th className="px-4 py-2 text-right text-[13px] font-medium text-foreground/80">
                  Avg Score
                </th>
                <th className="px-4 py-2 text-right text-[13px] font-medium text-foreground/80">
                  Count

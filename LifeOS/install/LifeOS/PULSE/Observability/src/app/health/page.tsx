    ...
    <section className="telos-card mission-card relative" style={{ cursor: "default" }}>
      ...
      <div className="flex items-start gap-6 flex-wrap">
        ...
        <div className="flex-1 min-w-0">
          <div className="text-[13px] uppercase tracking-widest muted mb-2" style={{ color: "#34D399" }}>Health</div>
    ...
    >
      ...
      <div className="space-y-1.5" data-sensitive>
        ...
        {file.sections.length > 8 && (
          <div className="text-[12px] italic pt-1 muted">
...
export default function HealthPage() {
  ...
  return (
    <div className="p-6 lg:p-8 max-w-[1920px] mx-auto space-y-6">
      ...
      {labs.length > 0 && (
        <section>
          <h2 className="text-[13px] font-medium uppercase tracking-widest muted mb-4 flex items-center gap-2">
      ...
      {nonLabs.length > 0 && (
        <section>
          <h2 className="text-[13px] font-medium uppercase tracking-widest muted mb-4" style={{ color: "#34D399" }}>
            Core Files
          </h2>
          <div className="prob-grid">
            {nonLabs.map((f) => (

/**
 * LifeOS Installer v6.0 — Type Definitions
...
export interface DetectionResult {
  ...
  configDir: string; // resolved ~/.claude/LIFEOS
}
...
export type ServerMessage =
  ...
  | { type: "copy_failures"; count: number; failures: string[] }
...
// Update these when cutting a new LifeOS release.
// The installer reads these constants — no other file should hardcode versions.

export const LIFEOS_VERSION = "6.0.0";
// Fallback only — the live LIFEOS/ALGORITHM/LATEST file is the single source
...
// Kept in sync with the LATEST file shipped in the v6.0.0 release bundle.
export const ALGORITHM_VERSION = "6.9.0";

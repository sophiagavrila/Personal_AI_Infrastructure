/**
 * LifeOS Installer v6.0 — CLI Interactive Prompts
 * readline-based input collection with proper cleanup.
 *
 * Non-interactive mode: when LIFEOS_TEST_AUTOMATED=1 or stdin is not a TTY
...
function isAutomated(): boolean {
  return process.env.LIFEOS_TEST_AUTOMATED === "1" || process.stdin.isTTY === false;
}

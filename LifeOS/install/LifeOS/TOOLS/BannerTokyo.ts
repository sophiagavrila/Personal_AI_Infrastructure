...
function designB(): string {
  return `
${DARK}▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀${RESET}
${MAGENTA}░${RESET} ${BOLD}${FG}WELCOME TO YOUR LifeOS SYSTEM${RESET}
${DARK}▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄${RESET}
...
function designC(): string {
  return `
${BLUE}╭─${RESET}${BOLD}${FG} LifeOS ${RESET}${BLUE}─────────────────────────────────────────────────────────
${BLUE}│${RESET}
...
function designD(): string {
  return `
${DARK}░▒▓${MAGENTA}█${RESET}${BOLD}${FG} WELCOME TO YOUR LifeOS SYSTEM ${RESET}${MAGENTA}█${DARK}▓▒░${RESET}

...
function design1_glitch(): string {
  ...
  return `
${DARK}░▒▓${CYAN}█${RESET}${BOLD}${CYAN} WELCOME TO YOUR LifeOS SYSTEM ${RESET}${CYAN}█${DARK}▓▒░░▒▓▒░${RESET}
...
function design2_holo(): string {
  return `
${CYAN}┌──${RESET}${BOLD} WELCOME TO YOUR LifeOS SYSTEM ${RESET}${CYAN}────────────────────────────
${CYAN}│${RESET}
${CYAN}│${RESET}   ${BOLD}${WHITE}╦╔═${CYAN}╔═╗${NEON_PINK}╦${RESET}
${CYAN}│${RESET}   ${BOLD}${WHITE}╠╩╗${CYAN}╠═╣${NEON_PINK}║${RESET}          ${DIM}LifeOS${RESET}
${CYAN}│${RESET}   ${BOLD}${WHITE}╩ ╩${CYAN}╩ ╩${NEON_PINK}╩${RESET}
${CYAN}│${RESET}
...
function design4_scanlines(): string {
  return `
${DARK}▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀${RESET}
${CYAN}░░${RESET} ${BOLD}WELCOME TO YOUR LifeOS SYSTEM${RESET}
${DARK}▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄${RESET}

${NEON_PINK}     ▄█▀▀█▄  ${CYAN}▄█▀▀█▄  ${WHITE}▀█▀${RESET}
${NEON_PINK}     █▄▀▀▄█  ${CYAN}█▄▀▀█▄  ${WHITE} █ ${RESET}    ${DIM}━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}
${NEON_PINK}     █  ▀▀█  ${CYAN}█  ▀▀█  ${WHITE} █ ${RESET}    ${DIM}LifeOS${RESET}
${NEON_PINK}     ▀█▄▄█▀  ${CYAN}▀█▄▄█▀  ${WHITE}▄█▄${RESET}    ${DIM}━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}

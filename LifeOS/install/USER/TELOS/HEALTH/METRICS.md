...
Health metrics, lab values, and trends.

---

## Key Numbers (Sample Panel — 2026-01-01)
...
## Trends (Sample — Two Panels Compared)
...
## Daily Metrics (Sample — Wearable/App Snapshot)
...
- All values above are placeholders. Replace each row with your real lab result before relying on the DA's analysis.

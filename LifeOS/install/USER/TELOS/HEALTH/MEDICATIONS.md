...
| Medication | Period | Reason | Status |
|------------|--------|--------|--------|
...
- List every medication you take regularly, even over-the-counter ones, so the DA can flag interactions when you ask about a new prescription or supplement.

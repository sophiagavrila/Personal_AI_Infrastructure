...
- Target: sample target — for example, 3 L water per day.
...
- Sample entry — for example, lactose sensitivity, gluten avoidance, tree-nut allergy.
...
- The DA uses this file to give context-aware nutrition advice. Vague placeholders produce vague advice. Specific real entries produce specific real advice.

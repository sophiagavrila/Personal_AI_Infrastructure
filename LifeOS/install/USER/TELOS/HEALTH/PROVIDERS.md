...
Healthcare providers and testing services.
...
| Specialty | Provider | Practice | Last Visit |
|-----------|----------|----------|------------|
...
- **Pharmacy:** Sample Pharmacy (sample)
- **Location:** Sample City, Sample State (sample)
...
- Use generic placeholder names like "Dr. Sample Provider" until you replace them. The DA will not invent real providers.

...
High-level snapshot of your financial state. Pulse reads this as the entry point for the Finance dashboard.
...
- Sample focus area 1 — e.g., reducing recurring software costs

...
Tax overview, estimated payments, and deductions to track. Pulse uses this to remind you of quarterly deadlines and surface deduction opportunities.

## Filing Profile

- **Filing status:** Sample (e.g., single / married filing jointly / head of household)
- **State:** Sample State
...
For 1099 / self-employment income.
...
- **Home office** — sample square footage, sample method (simplified / actual)
